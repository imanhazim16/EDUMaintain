    ...
    if (empty($name) || empty($email) || empty($password) || empty($role)) {
        ...
        if ($check->num_rows > 0) {
            ...
            if ($conn->query($sql) === TRUE) {
                $success = "Registration successful! <a href='login.php' class='fw-bold text-success'>Login here</a>";
            } else {
...
<head>
    ...
    <title>Sign Up - UiTM EduMaintain</title>
...
<body>
    ...
    <div class="login-container">
        <div class="brand-logo">
            <h2><i class="fas fa-user-plus me-2"></i> Join UiTM EduMaintain</h2>
        </div>
        ...
        <div class="card">
            ...
            <?php endif; ?>
            <?php if($success): ?>
                <div class="alert alert-success text-center p-2 small border-0 bg-success bg-opacity-25 text-white"><?php echo $success; ?></div>
            <?php endif; ?>
            ...
            <form method="POST">
                ...
                <div class="text-center mt-4">
                    <span style="color: rgba(255,255,255,0.6);" class="small">Already have an account? </span>
                    <a href="login.php" class="text-info small text-decoration-none fw-bold ms-1">Log In</a>
                </div>
            </form>
        </div>
